(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".swiper-pagination_main-block",
                clickable: true
            },
            navigation: {
            ...
            on: {
                init: function(swiper) {
                    const allSlides = document.querySelector(".fractionAll");
                    allSlides.innerHTML = swiper.slides.length < 10 ? `0${swiper.slides.length}` : swiper.slides.length;
                },
                slideChange: function(swiper) {
                    const currentSlide = document.querySelector(".js-swiper-controls__num");
                    currentSlide.innerHTML = swiper.activeIndex + 1 < 10 ? `0${swiper.activeIndex + 1}` : swiper.activeIndex + 1;
                }
            }
        });
        if (document.querySelector(".content-slider-skyscrapers__slider")) new core(".content-slider-skyscrapers__slider", {
            modules: [ Navigation, Pagination, Autoplay, EffectFade, Lazy, Manipulation ],
            observer: true,
            observeParents: true,
            slidesPerView: "1",
            ...
            pagination: {
                el: ".title-slider-skyscrapers__items",
                clickable: true
            },
            navigation: {
                prevEl: ".content-slider-skyscrapers__swiper-button-prev",
                nextEl: ".content-slider-skyscrapers__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 2,
            ...
            on: {
                init: function(swiper) {
                    const bulletTitle = document.querySelectorAll(".title-slider-skyscrapers__items .swiper-pagination-bullet");
                    bulletTitle[0].innerHTML = "<div>Москва-Сити</div>";
                    bulletTitle[1].innerHTML = "<div>Стадион «Спартак»</div>";
                    bulletTitle[2].innerHTML = "<div>ТРК «Авиапарк»</div>";
                    bulletTitle[3].innerHTML = "<div>АТК на Кутузовском</div>";
                    bulletTitle[4].innerHTML = "<div>Завод «ЗИЛ»</div>";
                },
                slideChange: function(swiper) {}
            }
        });
        if (document.querySelector(".how-we-work__slider")) new core(".how-we-work__slider", {
            modules: [ Navigation, Pagination, Autoplay, EffectFade, Lazy, Manipulation ],
            observer: true,
            observeParents: true,
            slidesPerView: "1",
            ...
            navigation: {
                prevEl: ".slide-work-we-how__swiper-button-prev",
                nextEl: ".slide-work-we-how__swiper-button-next"
            },
            on: {}
        });
    }
    ...
    da.init();
    const upload_element = (tag, classes = [], content) => {
    ...
    function upload(selector, options = {}) {
        ...
        const preview = upload_element("div", [ "preview" ]);
        preview.classList.add("preview");
        const open = upload_element("div", [ "body-files__btn" ], "Загрузить файл");
        open.classList.add("body-files__btn");
        open.textContent = "Загрузить файл";
        ...
        const changeHandler = event => {
            ...
            preview.innerHTML = "";
            files.forEach((file => {
                if (!file.type.match("doc") && file.type.match("txt") && file.type.match("DOCX") && file.type.match("OFC")) return;
                const reader = new FileReader;
                reader.onload = ev => {
                    ev.target.result;
                    preview.insertAdjacentHTML("afterbegin", `<div class="preview-image">\n\n                    <div class="preview-info">\n                        <span>${file.name}</span>\n                    </div>\n                    <div class="preview-remove _icon-trush" data-name="${file.name}"></div>\n                </div>`);
                };
    ...
    const fileName = document.querySelector(".download-estimate__file-name");
    ...
    Array.prototype.forEach.call(inputs, (function(input) {
        ...
        input.addEventListener("change", (function(e) {
            ...
            for (let i = 0; i < this.files.length; i++) fileName.innerHTML += `<div class='download-trush'>${this.files[i].name}<span class="_icon-trush"></span></div>`;
        }));
    }));
    if (document.querySelector(".body-files__input")) upload(".body-files__input", {
        multi: true,
        accept: [ ".DOC", ".DOCX", ".TXT", ".OFC" ]
    });
    const progress = document.getElementById("progress");
    const script_prev = document.getElementById("prev");
    const script_next = document.getElementById("next");
    const circles = document.querySelectorAll(".circle");
    let currentActive = 1;
    if (script_next) script_next.addEventListener("click", (() => {
        currentActive++;
        if (currentActive > circles.length) currentActive = circles.length;
        script_update();
    }));
    if (script_prev) script_prev.addEventListener("click", (() => {
        currentActive--;
    ...
    function script_update() {
        if (circles) {
            circles.forEach(((circle, idx) => {
                if (idx < currentActive) circle.classList.add("active"); else circle.classList.remove("active");
            }));
            const actives = document.querySelectorAll(".active");
            progress.style.height = (actives.length - 1) / (circles.length - 1) * 100 + "%";
            if (1 === currentActive) script_prev.disabled = true; else if (currentActive === circles.length) script_next.disabled = true; else {
                script_prev.disabled = false;
                script_next.disabled = false;
            }
        }
    }
    window["FLS"] = true;
